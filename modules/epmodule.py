...
class FeatExt3(nn.Module):
    def __init__(self, in_channel=3):
        ...
        self.init_conv = nn.Sequential(
            nn.Conv2d(self.in_channel, 8, 5, 2, 2, bias=False),
            nn.BatchNorm2d(8),
            nn.ReLU())  # half
        ...
        self.conv2_2 = Conv2d(base_channels * 2, base_channels * 4, 1, stride=2, relu=False)  # half
        ...
        self.conv4_2 = Conv2d(base_channels * 4, base_channels * 8, 1, stride=2, relu=False)  # half
        ...
        self.conv6_0 = nn.ConvTranspose2d(base_channels * 8, base_channels * 4, 3, 2, 1, 1, bias=False)  # two times
        ...
        self.conv7_0 = nn.ConvTranspose2d(base_channels * 4, base_channels * 2, 3, 2, 1, 1, bias=False)  # two times
...
class FeatExt3_ref(nn.Module):
    def __init__(self, in_channel=3):
        ...
        base_channels = 8
        self.init_conv = nn.Sequential(
            nn.Conv2d(self.in_channel, 8, 3, 1, 1, bias=False),
            nn.BatchNorm2d(8),
            nn.ReLU())
...
def epnet_loss(inputs, depth_gt_ms, mask_ms, proj_matrices, imgs, depth_interval, offsetnet_only, backbone_only, ph_w, **kwargs):
