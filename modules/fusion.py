...
class FeatureFusion(nn.Module):
    def __init__(self, convolutional_layer_encoding="z", mask_type="basic", add_origin_feat_flag=True,in_channels=3):
        ...
        # rgb encoder
        self.rgb_conv_init = convbnrelu(in_channels=self.in_channels+1, out_channels=8, kernel_size=5, stride=1, padding=2)
